...
class DataStatistics:
    ...
    def median(self):
        ...
        mid = n // 2
        if n % 2 == 0:
            return (all_numbers[mid - 1] + all_numbers[mid]) / 2
        else:
            return all_numbers[mid]
    
    def min(self):
        return min([num for container in self.containers for num in container.numbers])
    
    def sum(self):
        return sum([num for container in self.containers for num in container.numbers])
