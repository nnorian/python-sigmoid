...
text = "Creează o variabilă `text` \n și setează-i un text la alegere, \n cu restricția \n ca acesta să conțină mai multe rânduri"
print(text)
...
# CODUL TĂU VINE MAI JOS:
f_string = f"My name is {name}. Do not forget, it's {name2}!" 
print(f_string)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
fm_string = "My name is {}. Do not forget, it's {}!" .format(name, name2)
print(fm_string)
# CODUL TĂU VINE MAI SUS:
